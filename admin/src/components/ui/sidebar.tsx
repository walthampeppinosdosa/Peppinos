    ...
    >
      ...
      {state === "collapsed" && logo && (
        <div className="flex justify-center items-center py-4">
          {/* Increase logo size when collapsed */}
          {React.isValidElement(logo)
            ? React.cloneElement(logo, { width: 56, height: 56 })
            : logo}
        </div>
      )}
      {props.children}
